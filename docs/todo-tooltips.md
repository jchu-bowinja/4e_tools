...
- [ ] Generalize special-term handling (avoid UI-only term lookups)
  ...
  - Related: monster-facing tooltip items in `docs/todo-monsters.md` (glossary-driven matching, shared tooltip component); `src/data/tooltipGlossary.ts` and ETL that produce glossary JSON.
