...
- **Psionic power points** — `summarizePsionicPowerPointAdjustments` includes Psionic Augmentation class pool by level, feat swap deltas, and paragon +2 PP; non-psionic → psionic paragon MC loses one at-will slot. Hybrid PP pool deferred.
